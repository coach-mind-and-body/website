          ...
          >
            ...
            <div className="p-10" style={{ background: "oklch(0.96 0.025 50)" }}>
              ...
              <ul className="space-y-4 mb-6">
                ...
                <li>
                  <a href={BRAND.youtubeUrl} target="_blank" rel="noopener noreferrer" className="font-bold text-lg transition-opacity hover:opacity-70" style={{ color: "oklch(0.42 0.09 140)" }}>
                    YouTube Channel →
                  </a>
                </li>
              </ul>
              <div className="flex gap-4">
                <a href={BRAND.instagramUrl} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-12 h-12 flex items-center justify-center rounded-full bg-white shadow-sm transition-all hover:-translate-y-1" style={{ color: "oklch(0.42 0.09 140)" }}>
                ...
                <a href={BRAND.facebookUrl} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-12 h-12 flex items-center justify-center rounded-full bg-white shadow-sm transition-all hover:-translate-y-1" style={{ color: "oklch(0.42 0.09 140)" }}>
                ...
                <a href={BRAND.tiktokUrl} target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="w-12 h-12 flex items-center justify-center rounded-full bg-white shadow-sm transition-all hover:-translate-y-1" style={{ color: "oklch(0.42 0.09 140)" }}>
