...
export default function HolisticHealth() {
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <title>Holistic Health & Wellness Coaching | Mind & Body Reset</title>
        <meta
          name="description"
          content="Discover the power of holistic health and wellness. Learn how balancing your nervous system, healing insulin resistance, and adopting sustainable habits can transform your life."
        />
        <link rel="canonical" href="https://mindandbodyresetcoach.com/holistic-health-and-wellness" />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            "headline": "The Complete Guide to Holistic Health and Wellness",
            "description": "An in-depth look into functional holistic health, treating root causes of burnout, and resetting your metabolic health.",
            "author": {
              "@type": "Organization",
