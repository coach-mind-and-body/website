...
const STATIC_POSTS = [
  { slug: "midlife-body-image", category: "Body Image", date: "March 2, 2026", publishedAt: new Date("2026-03-02"), title: "Midlife Body Image: Your Body is Not a Before Picture", excerpt: "Rebuilding body confidence after 40 — why your internal commentary is a habit, not a truth.", coverImage: null },
  { slug: "embrace-reflection", category: "Mindset & Self-Compassion", date: "February 13, 2026", publishedAt: new Date("2026-02-13"), title: "Embrace Reflection: Shifting from Fault-Finding to Self-Awareness", excerpt: "How to stop negative self-talk in the mirror and break the fault-finding cycle.", coverImage: null },
  { slug: "calming-food-noise", category: "Mindful Eating & Nutrition", date: "February 6, 2026", publishedAt: new Date("2026-02-06"), title: "Calming Food Noise: Drop the Mental Food Fight", excerpt: "Practical strategies to quiet the constant mental chatter about food.", coverImage: null },
  ...
  { slug: "food-freedom", category: "Mindful Eating & Nutrition", date: "January 22, 2026", publishedAt: new Date("2026-01-22"), title: "Food Freedom Isn't About Willpower — It's About Rewiring", excerpt: "The real reason diets don't stick and what neuroscience says about lasting change.", coverImage: null },
  { slug: "thought-work-intro", category: "Thought Work", date: "January 15, 2026", publishedAt: new Date("2026-01-15"), title: "What Is Thought Work and Why Does It Change Everything?", excerpt: "An introduction to the most powerful tool in the coaching toolkit — and why it's not therapy.", coverImage: null },
];
