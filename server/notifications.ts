...
export async function sendPostSessionSMS(params: {
  ...
  let body: string;
  if (isLastSession) {
    body = `Congratulations ${clientName}! 🎉 You've completed all 6 sessions of the Mind and Body Reset Coaching program. It's been an honor working with you! Visit your portal to access all your session notes: ${portalUrl}`;
  } else {
...
export async function sendPostSessionEmail(params: {
  ...
  const subject = isLastSession
    ? `🎉 Congratulations on Completing Your Mind and Body Reset Coaching!`
  ...
  const htmlBody = `
    <div style="font-family:'Nunito Sans',Arial,sans-serif;max-width:600px;margin:0 auto;background:#fff;">
      <div style="background:#c9a96e;padding:32px 40px;text-align:center;">
        <h1 style="margin:0;color:white;font-size:24px;font-weight:700;">Mind and Body Reset Coaching</h1>
      </div>
      <div style="padding:32px 40px;">
        <p style="color:#4a4a4a;font-size:16px;">Hi ${clientName},</p>
        ${isLastSession
          ? `<p style="color:#4a4a4a;font-size:16px;">🎉 <strong>Congratulations!</strong> You've completed all 6 sessions of the Mind and Body Reset Coaching program. This is a huge milestone and you should be incredibly proud of the work you've done.</p>`
          : `<p style="color:#4a4a4a;font-size:16px;">Great work completing <strong>Session ${sessionNumber}: ${sessionLabel}</strong>! You're making real progress on your Mind and Body Reset Coaching journey.</p>`
        }
        ${notesSection}
        ${ctaSection}
        <hr style="border:none;border-top:1px solid #e8e0d8;margin:32px 0;" />
        <p style="color:#8a9a8a;font-size:13px;text-align:center;">
          Mind and Body Reset Coaching with Lee Anne<br/>
  ...
  const textBody = isLastSession
    ? `Hi ${clientName},\n\nCongratulations on completing all 6 sessions of the Mind and Body Reset Coaching program!\n\n${adminNotes ? `Lee Anne's Notes:\n${adminNotes}\n\n` : ""}Visit your portal: ${portalUrl}`
...
<div style="font-family:'Georgia',serif;max-width:600px;margin:0 auto;background:#fffdf9;border:1px solid #e8ddd0;border-radius:12px;overflow:hidden;">
  <div style="background:linear-gradient(135deg,#3a6b35 0%,#2d5229 100%);padding:28px 32px;text-align:center;">
    <p style="margin:0;font-size:13px;letter-spacing:2px;text-transform:uppercase;color:rgba(255,255,255,0.75);">Mind and Body Reset Coaching</p>
  ...
  <div style="background:#f4f0eb;padding:16px 32px;text-align:center;border-top:1px solid #e8ddd0;">
    <p style="margin:0;font-size:12px;color:#8a7060;">Mind and Body Reset Coaching · Sent via your portal</p>
  </div>
</div>`;
  ...
  const textBody = [
    ...
    ``,
    `Lee Anne — Mind and Body Reset Coaching`,
  ].join("\n");
...
<div style="font-family:'Georgia',serif;max-width:600px;margin:0 auto;background:#fffdf9;border:1px solid #e8ddd0;border-radius:12px;overflow:hidden;">
  ...
  <div style="padding:32px;">
    ...
    <p style="margin:16px 0 0;font-size:15px;color:#3a3028;font-weight:600;">
      — Lee Anne<br/>
      <span style="font-weight:400;color:#8a7060;font-size:13px;">Mind and Body Reset Coaching · Certified Life &amp; Health Coach</span>
    </p>
  </div>
  <div style="background:#f4f0eb;padding:16px 32px;text-align:center;border-top:1px solid #e8ddd0;">
    <p style="margin:0;font-size:12px;color:#8a7060;">Mind and Body Reset Coaching · You're receiving this because you signed up for FPU.</p>
  </div>
</div>`;
  ...
  const htmlBody = `
    <div style="font-family:'Nunito Sans',Arial,sans-serif;max-width:600px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
      ...
      <div style="padding:36px 40px;">
        ...
        <p style="color:#4a4a4a;font-size:16px;margin:0 0 16px;">Taking the time to reflect and complete these exercises is a crucial part of your Mind and Body Reset Coaching journey. Whenever you're ready, you can jump back in.</p>
        <div style="text-align:center;margin:28px 0;">
